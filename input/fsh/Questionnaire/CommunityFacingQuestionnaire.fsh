...
* meta.versionId = "2"
* meta.lastUpdated = "2025-08-14T10:00:00.000+02:00"
* language = #en
...
//* contained[0] = cfq-yes-no
//* contained[+] = cfq-severity
...
* item[=].item[=].item[=].answerValueSet = "https://simplifier.net/guide/hmb-fhir-ig/ValueSet/yes-no"
...
* item[=].item[=].answerValueSet = "https://simplifier.net/guide/hmb-fhir-ig/ValueSet/yes-no"
...
* item[=].item[=].item[=].answerValueSet = "https://simplifier.net/guide/hmb-fhir-ig/ValueSet/severity"
* item[=].item[=].item[=].extension[0].url = "http://hl7.org/fhir/StructureDefinition/questionnaire-itemControl"
* item[=].item[=].item[=].extension[=].valueCodeableConcept = http://hl7.org/fhir/questionnaire-item-control#radio-button
